...
\begin{tikzpicture}[node distance=2.5cm, every edge/.style={link}]
  ...
  % \node[isa] (BookingCancellationIsa) [below left = of Cancellations] {ISA} edge (Cancellations);
  % \node[isa] (BookingCancellationIsa) [below right = of Cancellations] {ISA} edge (Cancellations);
